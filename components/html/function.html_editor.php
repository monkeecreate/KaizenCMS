...
function smarty_function_html_editor($aParams, &$smarty) {
	...
	$return .= "<script>if(typeof(tinymce) === 'undefined') { document.write('<script src=\"/js/tiny_mce/tiny_mce.js\"><\/script>'); }</script>\n";
	...
	$return .= "\tskin : 'default',\n";
	$return .= "\tplugins : 'safari,contextmenu,advlist,embed,imagemanager,filemanager,advimage,advlink,paste,table,preview,fullscreen,searchreplace,spellchecker,autolink,tabfocus',\n";
