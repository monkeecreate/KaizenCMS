{include file="inc_header.tpl" page_title="Events :: Edit Event" menu="events"}
<form method="post" action="/admin/events/edit/s/">
	...
	<input type="submit" value="Save Changes" class="btn ui-button ui-corner-all ui-state-default"> <input type="button" value="Cancel" onclick="location.href = '/admin/events/';" class="btn ui-button ui-corner-all ui-state-default">
