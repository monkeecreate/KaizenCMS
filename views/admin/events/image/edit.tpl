{include file="inc_header.tpl" page_title="Events :: Crop Image" menu="events"}
{head}
	...
	<table border="0">
		...
		<tr>
			<td>
				...
				<input type="submit" value="Save Changes" class="btn ui-button ui-corner-all ui-state-default"> - <input type="button" value="Upload new photo" onclick="location.href = '/admin/events/image/{$aEvent.id}/upload/';" class="btn ui-button ui-corner-all ui-state-default"> - <input type="button" value="Remove Photo" onclick="location.href = '/admin/events/image/{$aEvent.id}/delete/';" class="btn ui-button ui-corner-all ui-state-default">
			</td>
		</tr>
	</table>
</form>
