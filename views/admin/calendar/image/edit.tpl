...
<form name="crop" action="/admin/calendar/image/edit/s/" method="post">
	<input type="submit" value="Save Changes"> - <input type="button" value="Upload new photo" onclick="location.href = '/admin/member/calendar/photo/upload/{$photo.id}/';" /> - <input type="button" value="Remove Photo" onclick="location.href = '/admin/member/calendar/photo/delete/{$photo.id}/';" />
	<table border="0">
		<tr>
			<td>
