...
<form method="post" action="/admin/links/edit/s/">
	...
	<input type="submit" value="Save Changes" class="btn ui-button ui-corner-all ui-state-default"> <input type="button" value="Cancel" onclick="location.href = '/admin/links/';" class="btn ui-button ui-corner-all ui-state-default">
