...
<form method="post" action="/admin/faq/edit/s/" enctype="multipart/form-data">
	...
	<input type="submit" value="Save Changes" class="btn ui-button ui-corner-all ui-state-default"> <input type="button" value="Cancel" onclick="location.href = '/admin/faq/';" class="btn ui-button ui-corner-all ui-state-default">
