{include file="inc_header.tpl" page_title="Directory :: Edit Listing" menu="directory"}
<style type="text/css">
.upload_block {ldelim}
	float:left;
	background: #EFEFEF;
...
<form method="post" action="/admin/directory/edit/s/" enctype="multipart/form-data">
	...
	<input type="submit" value="Save Changes" class="btn ui-button ui-corner-all ui-state-default"> <input type="button" value="Cancel" onclick="location.href = '/admin/directory/';" class="btn ui-button ui-corner-all ui-state-default">
