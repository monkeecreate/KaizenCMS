...
<form method="post" action="/admin/news/add/s/">
	...
	<textarea name="short_content" class="elastic">{$aArticle.short_content|htmlspecialchars|stripslashes}</textarea><br>
	<div class="clear"></div>
	<label>Content:</label>
	...
	<input type="submit" name="next" value="Add Article"> <input type="submit" name="next" value="Add Article & Add Image"> <input type="button" value="Cancel" onclick="location.href = '/admin/news/';">
</form>
