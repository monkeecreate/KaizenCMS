<?php
	...
	$mcFileManagerConfig['filesystem.rootpath'] = dirname(dirname(dirname(dirname(dirname(__FILE__))))).'/uploads/editor/files'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,doc,docx";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,doc,docx";
	...
	$mcFileManagerConfig['authenticator.login_page'] = "/admin/";
