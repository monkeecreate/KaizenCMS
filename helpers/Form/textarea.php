...
class Form_textarea extends Form_Field
{
	...
	public function html() {
		...
		$sHTML .= '<textarea name="settings['.$this->_setting["tag"].']" id="form-'.urlencode(stripslashes($this->_setting["title"])).'" class="span12" style="height: 115px;">'.$this->value(false).'</textarea>';
