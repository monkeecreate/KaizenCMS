...
The requirements are simple. Apache 2+ and PHP 5+. PEAR and Memcache are recommended but not required. Crane | West CMS will not work in a sub directory. It must be the root domain or a subdomain.
...
James Fleeting, "http://jamesfleeting.com":http://jamesfleeting.com
