{include file="inc_header.tpl" page_title="News Articles :: Add Article" menu="news" page_style="halfContent"}
{head}
...
<form method="post" action="/admin/news/add/s/" enctype="multipart/form-data">
