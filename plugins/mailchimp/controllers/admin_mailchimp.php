...
class admin_mailchimp extends adminController {
	...
	function campaigns_index() {
		...
		$this->tplDisplay("admin/campaigns/index.tpl");
	}
	...
	function lists_index() {
		...
		$this->tplDisplay("admin/lists/index.tpl");
	}
	function lists_show() {
	...
	function lists_members() {
		...
		$this->tplDisplay("admin/lists/members.tpl");
	}
	...
	function lists_member() {
		...
		$this->tplDisplay("admin/lists/member.tpl");
	}
