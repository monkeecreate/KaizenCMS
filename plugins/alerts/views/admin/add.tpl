{include file="inc_header.tpl" page_title="Alerts :: Add Alert" menu="alerts" page_style="halfContent"}
{head}
...
<form method="post" action="/admin/alerts/add/s/" enctype="multipart/form-data">
	<section id="content" class="content">
		<header>
			<h2>Manage Alerts &raquo; Add Alert</h2>
		</header>
		...
		<section class="inner-content">
			...
			<textarea name="content" style="height:115px;">{$aAlert.content}</textarea><br />
			
			<input type="submit" name="next" value="Add Alert">
...
$(function(){ldelim}
	...
	$('textarea[name=content]').keyup(function() {ldelim}
