{include file="inc_header.tpl" page_title="Banners :: Add Banner" menu="banners" page_style="halfContent"}
{head}
...
<form method="post" action="/admin/banners/add/s/" enctype="multipart/form-data">
	<section id="content" class="content">
		<header>
			<h2>Manage Banners &raquo; Add Banner</h2>
		</header>
...
$(function(){ldelim}
	...
	$("form").validateForm([
		...
		"required,banner,Banner is required",
