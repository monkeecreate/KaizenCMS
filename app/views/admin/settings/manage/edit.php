<?php $this->tplDisplay("inc_header.php", ['menu'=>'settings','subMenu'=>'Manage Settings','sPageTitle'=>"Manage Settings &raquo; Edit Settings"]); ?>

	<h1>Manage Settings &raquo; Edit Setting</h1>
	<?php $this->tplDisplay('inc_alerts.php'); ?>

	<form id="edit-form" class="form-horizontal" method="post" action="/admin/settings/manage/edit/s/">
		<div class="row-fluid">
			<div class="span8">
