...
<head>
	...
	<title><?php if(!empty($sPageTitle)){ echo $sPageTitle.' | '; } echo $this->getSetting("site-title"); ?></title>
	...
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="/" title="Visit http://<?php $_SERVER['SERVER_NAME'] ?>/" rel="tooltip" data-placement="bottom"><?= $this->getSetting("site-title") ?></a>
