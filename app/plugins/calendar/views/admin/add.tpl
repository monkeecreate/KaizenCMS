{include file="inc_header.php" page_title="Calendar :: Add Event" menu="calendar" page_style="halfContent"}
{head}
...
<form method="post" action="/admin/calendar/add/s/" enctype="multipart/form-data">
	<section id="content" class="content">
		...
		<section class="inner-content">
			...
			<textarea name="short_content" style="height:115px;">{$aEvent.short_content}</textarea><br />
