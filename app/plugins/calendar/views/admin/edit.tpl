{include file="inc_header.php" page_title="Calendar :: Edit Event" menu="calendar" page_style="halfContent"}
		...
		<section>
			...
			<fieldset>
				...
				<span class="expireDate {if $aEvent.use_kill == 0}hidden{/if}">
					...
					<input type="checkbox" name="use_kill" value="1" class="hidden"{if $aEvent.use_kill == 1} checked="checked"{/if}>
				</span>
...
$(function(){
	...
	$('input[name=post_twitter], input[name=post_facebook]').iphoneStyle({
		checkedLabel: 'Yes',
		uncheckedLabel: 'No'
	});
	...
	$('textarea[name=short_content]').keyup(function() {
