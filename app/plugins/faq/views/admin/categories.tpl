{include file="inc_header.php" page_title="FAQ Categories" menu="faq" page_style="halfContent"}
					...
					{if $sSort == "manual"}
						<td class="small center">
							...
							{if $aCategory.sort_order != $minSort}
								<a href="/admin/faq/categories/sort/{$aCategory.id}/up/" title="Move Up One"><img src="/images/admin/icons/bullet_arrow_up.png" style="width:16px;height:16px;"></a>
							{else}
								<img src="/images/blank.gif" style="width:16px;height:16px;">
							{/if}
							{if $aCategory.sort_order != $maxSort && count($aCategories) > 1}
								<a href="/admin/faq/categories/sort/{$aCategory.id}/down/" title="Move Down One"><img src="/images/admin/icons/bullet_arrow_down.png" style="width:16px;height:16px;"></a>
							{else}
								<img src="/images/blank.gif" style="width:16px;height:16px;">
							{/if}
						</td>
