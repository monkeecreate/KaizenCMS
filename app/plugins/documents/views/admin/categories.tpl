{include file="inc_header.php" page_title="Document Categories" menu="documents" page_style="halfContent"}
		...
		<tbody>
			{foreach from=$aCategories item=aCategory}
				<tr>
					...
					{if $sSort == "manual"}
						<td class="small center">
							...
							{if $aCategory.sort_order != $minSort}
								<a href="/admin/documents/categories/sort/{$aCategory.id}/up/" title="Move Up One"><img src="/images/admin/icons/bullet_arrow_up.png" style="width:16px;height:16px;"></a>
							{else}
								<img src="/images/blank.gif" style="width:16px;height:16px;">
							{/if}
							{if $aCategory.sort_order != $maxSort && count($aCategories) > 1}
								<a href="/admin/documents/categories/sort/{$aCategory.id}/down/" title="Move Down One"><img src="/images/admin/icons/bullet_arrow_down.png" style="width:16px;height:16px;"></a>
							{else}
								<img src="/images/blank.gif" style="width:16px;height:16px;">
							{/if}
						</td>
					{/if}
					<td class="center">
						<a href="/admin/documents/categories/?category={$aCategory.id}" title="Edit Category">
...
<section id="sidebar" class="sidebar">
	...
	{else}
		...
		<section>
			<form method="post" id="addCategory-form" action="/admin/documents/categories/add/s/">
				<label>Name:</label>
